...
@ManagedBean(name = "LoanExpertTaskOverview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "LoanExpertTaskOverview", beanType = BeanType.PORTLET)
public class LoanExpertTaskOverview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {

	private transient caf.war.LoanTasksProject.LoanTasksProject loanTasksProject = null;
	/**
	...
	public caf.war.LoanTasksProject.LoanTasksProject getLoanTasksProject()  {
		if (loanTasksProject == null) {
		    loanTasksProject = (caf.war.LoanTasksProject.LoanTasksProject)resolveExpression("#{LoanTasksProject}");
		}
		return loanTasksProject;
	}
