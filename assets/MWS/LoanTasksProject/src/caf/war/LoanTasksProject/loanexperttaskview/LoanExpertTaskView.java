...
@ManagedBean(name = "LoanExpertTaskView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "LoanExpertTaskView", beanType = BeanType.PORTLET)
public class LoanExpertTaskView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
