...
@ManagedBean(name = "ConfirmPaymentOverview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "ConfirmPaymentOverview", beanType = BeanType.PORTLET)
public class ConfirmPaymentOverview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {

	private transient caf.war.confirmPaymentProject.ConfirmPaymentProject confirmPaymentProject = null;
	/**
	...
	public caf.war.confirmPaymentProject.ConfirmPaymentProject getConfirmPaymentProject()  {
		if (confirmPaymentProject == null) {
		    confirmPaymentProject = (caf.war.confirmPaymentProject.ConfirmPaymentProject)resolveExpression("#{ConfirmPaymentProject}");
		}
		return confirmPaymentProject;
	}
