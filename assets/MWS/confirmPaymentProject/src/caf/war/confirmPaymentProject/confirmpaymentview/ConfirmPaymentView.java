...
@ManagedBean(name = "ConfirmPaymentView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "ConfirmPaymentView", beanType = BeanType.PORTLET)
public class ConfirmPaymentView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
