...
@ManagedBean(name = "TesttaskView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "TesttaskView", beanType = BeanType.PORTLET)
public class TesttaskView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {

	private transient caf.war.testTaskProject.TestTaskProject testTaskProject = null;
	/**
	...
	public caf.war.testTaskProject.TestTaskProject getTestTaskProject()  {
		if (testTaskProject == null) {
		    testTaskProject = (caf.war.testTaskProject.TestTaskProject)resolveExpression("#{TestTaskProject}");
		}
		return testTaskProject;
	}
