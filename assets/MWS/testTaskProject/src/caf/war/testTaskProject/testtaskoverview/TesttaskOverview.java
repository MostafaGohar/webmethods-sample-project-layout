...
@ManagedBean(name = "TesttaskOverview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "TesttaskOverview", beanType = BeanType.PORTLET)
public class TesttaskOverview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
